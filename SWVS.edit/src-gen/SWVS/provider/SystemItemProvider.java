...
public class SystemItemProvider extends ObjectItemProvider {
	...
	protected void addSystemTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_System_systemType_feature"),
	...
	protected void addDefClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_System_defClass_feature"),
	...
	protected void addRequirementPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_System_requirement_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_System_requirement_feature",
								"_UI_System_type"),
						SWVSPackage.Literals.SYSTEM__REQUIREMENT, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(SWVSPackage.Literals.SYSTEM__USECASE, SWVSFactory.eINSTANCE.createUseCase()));

		newChildDescriptors
				.add(createChildParameter(SWVSPackage.Literals.SYSTEM__STATE, SWVSFactory.eINSTANCE.createState()));
	}
