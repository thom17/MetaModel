...
public class ClassItemProvider extends ObjectItemProvider {
	...
	protected void addPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Class_package_feature"),
	...
	protected void addHasClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Class_hasClass_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Class_hasClass_feature", "_UI_Class_type"),
	...
	protected void addDefBasePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Class_defBase_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Class_defBase_feature", "_UI_Class_type"),
	...
	protected void addClassTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Class_classType_feature"),
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(SWVSPackage.Literals.CLASS__FIELD, SWVSFactory.eINSTANCE.createField()));

		newChildDescriptors
				.add(createChildParameter(SWVSPackage.Literals.CLASS__METHOD, SWVSFactory.eINSTANCE.createMethod()));
	}
