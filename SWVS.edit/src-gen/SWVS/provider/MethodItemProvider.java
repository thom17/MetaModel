...
public class MethodItemProvider extends ObjectItemProvider {
	...
	protected void addFlowPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Method_flow_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Method_flow_feature", "_UI_Method_type"),
						SWVSPackage.Literals.METHOD__FLOW, true, false, true, null, null, null));
	}
	...
	protected void addIsStaticPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Method_isStatic_feature"),
	...
	protected void addUsecasePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Method_usecase_feature"),
