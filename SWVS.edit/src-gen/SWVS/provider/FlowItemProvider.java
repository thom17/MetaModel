 ...
 * @generated
 */
public class FlowItemProvider extends MObjectItemProvider {
  /**
  ...
  protected void addFlowIdPropertyDescriptor(Object object) {
    itemPropertyDescriptors
        .add(createItemPropertyDescriptor(
            ...
            getString("_UI_PropertyDescriptor_description", "_UI_Flow_flowId_feature",
                "_UI_Flow_type"),
  ...
  protected void addHostPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_Flow_host_feature"),
  ...
  protected void addClientsPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Flow_clients_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_Flow_clients_feature",
            "_UI_Flow_type"),
        SWVSPackage.Literals.FLOW__CLIENTS, true, false, true, null, null, null));
  }
  ...
  protected void addContextPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Flow_context_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_Flow_context_feature",
            "_UI_Flow_type"),
  ...
  protected void addResultPropertyDescriptor(Object object) {
    itemPropertyDescriptors
        .add(createItemPropertyDescriptor(
            ...
            getString("_UI_PropertyDescriptor_description", "_UI_Flow_result_feature",
                "_UI_Flow_type"),
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(SWVSPackage.Literals.FLOW__DETAIL_FLOWS);
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(SWVSPackage.Literals.FLOW__DETAIL_FLOWS,
        SWVSFactory.eINSTANCE.createFlow()));

    newChildDescriptors.add(createChildParameter(SWVSPackage.Literals.FLOW__CONDITION,
