...
public class ProjectItemProvider extends ItemProviderAdapter
  ...
  protected void addObjectsPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Project_objects_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_Project_objects_feature",
            "_UI_Project_type"),
        SWVSPackage.Literals.PROJECT__OBJECTS, true, false, true, null, null, null));
  }
  ...
  protected void addFinDatePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Project_finDate_feature"),
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(SWVSPackage.Literals.PROJECT__SYSTEMS);
      childrenFeatures.add(SWVSPackage.Literals.PROJECT__ACTOR_LIST);
      childrenFeatures.add(SWVSPackage.Literals.PROJECT__CLASS_LIST);
      childrenFeatures.add(SWVSPackage.Literals.PROJECT__MOBJECTS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add(createChildParameter(SWVSPackage.Literals.PROJECT__SYSTEMS,
        SWVSFactory.eINSTANCE.createMSystem()));

    newChildDescriptors.add(createChildParameter(SWVSPackage.Literals.PROJECT__ACTOR_LIST,
        SWVSFactory.eINSTANCE.createActor()));

    newChildDescriptors.add(createChildParameter(SWVSPackage.Literals.PROJECT__CLASS_LIST,
        SWVSFactory.eINSTANCE.createMClass()));

    newChildDescriptors.add(createChildParameter(SWVSPackage.Literals.PROJECT__MOBJECTS,
        SWVSFactory.eINSTANCE.createMObject()));
  ...
  public String getCreateChildText(Object owner, Object feature, Object child,
    ...
    boolean qualify = childFeature == SWVSPackage.Literals.PROJECT__REQUIREMENT
        || childFeature == SWVSPackage.Literals.PROJECT__MOBJECTS
        || childFeature == SWVSPackage.Literals.PROJECT__SYSTEMS
        || childFeature == SWVSPackage.Literals.PROJECT__ACTOR_LIST
        || childFeature == SWVSPackage.Literals.PROJECT__CLASS_LIST;
