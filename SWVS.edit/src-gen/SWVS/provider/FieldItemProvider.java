...
/**
 * This is the item provider adapter for a {@link SWVS.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldItemProvider extends MObjectItemProvider {
  /**
  ...
  protected void addTypeNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ...
        getString("_UI_PropertyDescriptor_description", "_UI_Field_typeName_feature",
            "_UI_Field_type"),
        SWVSPackage.Literals.FIELD__TYPE_NAME, true, false, false,
  ...
  protected void addIsClassPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(
        ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
        getString("_UI_Field_isClass_feature"),
        getString("_UI_PropertyDescriptor_description", "_UI_Field_isClass_feature",
            "_UI_Field_type"),
        SWVSPackage.Literals.FIELD__IS_CLASS, true, false, false,
