 ...
 * @generated
 */
public class UseCaseItemProvider extends ObjectItemProvider {
	/**
	...
	protected void addContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UseCase_context_feature"),
	...
	protected void addActActorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UseCase_actActors_feature"),
	...
	protected void addRequirementPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UseCase_requirement_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_UseCase_requirement_feature",
								"_UI_UseCase_type"),
						SWVSPackage.Literals.USE_CASE__REQUIREMENT, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SWVSPackage.Literals.USE_CASE__FLOW);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(SWVSPackage.Literals.USE_CASE__EXTEND, SWVSFactory.eINSTANCE.createUseCase()));

		newChildDescriptors.add(
				createChildParameter(SWVSPackage.Literals.USE_CASE__INCLUDE, SWVSFactory.eINSTANCE.createUseCase()));

		newChildDescriptors
				.add(createChildParameter(SWVSPackage.Literals.USE_CASE__FLOW, SWVSFactory.eINSTANCE.createFlow()));
