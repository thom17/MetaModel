...
public class RequirementImpl extends ObjectImpl implements Requirement {
	...
	public void setContents(String newContents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.REQUIREMENT__CONTENTS, oldContents,
					contents));
	}
	...
	public void setRqType(String newRqType) {
		...
		rqType = newRqType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.REQUIREMENT__RQ_TYPE, oldRqType, rqType));
	}
	...
	public void setDepartment(String newDepartment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.REQUIREMENT__DEPARTMENT, oldDepartment,
					department));
	}
