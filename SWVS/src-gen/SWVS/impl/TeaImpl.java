...
public class TeaImpl extends BeverageImpl implements Tea {
	...
	public NotificationChain basicSetTea_back(Tea_Back newTea_back, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SWVSPackage.TEA__TEA_BACK,
					oldTea_back, newTea_back);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTea_back(Tea_Back newTea_back) {
		if (newTea_back != tea_back) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.TEA__TEA_BACK, newTea_back, newTea_back));
	}
