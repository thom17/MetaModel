...
public class StateImpl extends MinimalEObjectImpl.Container implements State {
  ...
  public void setStateId(String newStateId) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.STATE__STATE_ID, oldStateId,
          stateId));
  }
  ...
  public void setUseCaseStatus(String newUseCaseStatus) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.STATE__USE_CASE_STATUS,
          oldUseCaseStatus, useCaseStatus));
  }
  ...
  public void setImplementationStatus(String newImplementationStatus) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          SWVSPackage.STATE__IMPLEMENTATION_STATUS, oldImplementationStatus, implementationStatus));
  }
