 ...
 * @generated
 */
public class FieldImpl extends ObjectImpl implements Field {
	/**
	...
	public void setTypeName(String newTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.FIELD__TYPE_NAME, oldTypeName, typeName));
	}
	...
	public void setIsClass(boolean newIsClass) {
		...
		isClass = newIsClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.FIELD__IS_CLASS, oldIsClass, isClass));
	}
