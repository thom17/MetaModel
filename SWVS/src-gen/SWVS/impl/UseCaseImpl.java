 ...
 *   <li>{@link SWVS.impl.UseCaseImpl#getRequirement <em>Requirement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UseCaseImpl extends ObjectImpl implements UseCase {
	...
	public EList<UseCase> getExtend() {
		if (extend == null) {
			extend = new EObjectContainmentEList<UseCase>(UseCase.class, this, SWVSPackage.USE_CASE__EXTEND);
		}
		return extend;
	}
	...
	public EList<UseCase> getInclude() {
		if (include == null) {
			include = new EObjectContainmentEList<UseCase>(UseCase.class, this, SWVSPackage.USE_CASE__INCLUDE);
		}
		return include;
	}
	...
	public void setContext(String newContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.USE_CASE__CONTEXT, oldContext, context));
	}
	...
	public void setCondition(Condition newCondition) {
		if (newCondition != condition) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.USE_CASE__CONDITION, newCondition,
					newCondition));
	}
	...
	public EList<Requirement> getRequirement() {
		if (requirement == null) {
			requirement = new EObjectResolvingEList<Requirement>(Requirement.class, this,
					SWVSPackage.USE_CASE__REQUIREMENT);
		}
		return requirement;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case SWVSPackage.USE_CASE__ACT_ACTORS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getActActors()).basicAdd(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case SWVSPackage.USE_CASE__CONDITION:
			return getCondition();
		case SWVSPackage.USE_CASE__REQUIREMENT:
