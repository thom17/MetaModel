...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MObject</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link SWVS.impl.MObjectImpl#getId <em>Id</em>}</li>
 *   <li>{@link SWVS.impl.MObjectImpl#getData_base_SrcName <em>Data base Src Name</em>}</li>
 *   <li>{@link SWVS.impl.MObjectImpl#getObjectType <em>Object Type</em>}</li>
 *   <li>{@link SWVS.impl.MObjectImpl#getFilePath <em>File Path</em>}</li>
 *   <li>{@link SWVS.impl.MObjectImpl#isAddedObject <em>Added Object</em>}</li>
 *   <li>{@link SWVS.impl.MObjectImpl#getImplementName <em>Implement Name</em>}</li>
 *   <li>{@link SWVS.impl.MObjectImpl#getObjectName <em>Object Name</em>}</li>
 *   <li>{@link SWVS.impl.MObjectImpl#getRequirements <em>Requirements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MObjectImpl extends MinimalEObjectImpl.Container implements MObject {
  /**
  ...
  protected EClass eStaticClass() {
    return SWVSPackage.Literals.MOBJECT;
  }
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.MOBJECT__ID, oldId, id));
  }
  ...
  public void setData_base_SrcName(String newData_base_SrcName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.MOBJECT__DATA_BASE_SRC_NAME,
  ...
  public void setObjectType(String newObjectType) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.MOBJECT__OBJECT_TYPE,
  ...
  public void setFilePath(String newFilePath) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.MOBJECT__FILE_PATH,
  ...
  public void setAddedObject(boolean newAddedObject) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.MOBJECT__ADDED_OBJECT,
          oldAddedObject, addedObject));
  }
  ...
  public void setImplementName(String newImplementName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.MOBJECT__IMPLEMENT_NAME,
          oldImplementName, implementName));
  }
  ...
  public void setObjectName(String newObjectName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.MOBJECT__OBJECT_NAME,
  ...
  public EList<Requirement> getRequirements() {
    if (requirements == null) {
      requirements = new EObjectResolvingEList<Requirement>(Requirement.class, this,
          SWVSPackage.MOBJECT__REQUIREMENTS);
    }
    return requirements;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case SWVSPackage.MOBJECT__REQUIREMENTS:
