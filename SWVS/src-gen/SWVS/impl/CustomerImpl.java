...
public class CustomerImpl extends MinimalEObjectImpl.Container implements Customer {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.CUSTOMER__NAME, oldName, name));
	}
	...
	public void setBeverage(Beverage newBeverage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.CUSTOMER__BEVERAGE, oldBeverage,
					beverage));
	}
