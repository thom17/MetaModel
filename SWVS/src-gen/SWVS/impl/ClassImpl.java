...
public class ClassImpl extends ObjectImpl implements SWVS.Class {
	...
	public void setPackage(String newPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.CLASS__PACKAGE, oldPackage, package_));
	}
	...
	public EList<SWVS.Class> getHasClass() {
		if (hasClass == null) {
			hasClass = new EObjectResolvingEList<SWVS.Class>(SWVS.Class.class, this, SWVSPackage.CLASS__HAS_CLASS);
		}
		return hasClass;
	}
	...
	public EList<SWVS.Class> getSuperClass() {
		if (superClass == null) {
			superClass = new EObjectResolvingEList<SWVS.Class>(SWVS.Class.class, this, SWVSPackage.CLASS__SUPER_CLASS);
		}
		return superClass;
	}
	...
	public EList<SWVS.Object> getDefBase() {
		if (defBase == null) {
			defBase = new EObjectResolvingEList<SWVS.Object>(SWVS.Object.class, this, SWVSPackage.CLASS__DEF_BASE);
		}
		return defBase;
	}
	...
	public void setClassType(String newClassType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.CLASS__CLASS_TYPE, oldClassType,
					classType));
	}
