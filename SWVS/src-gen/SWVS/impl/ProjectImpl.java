...
public class ProjectImpl extends MinimalEObjectImpl.Container implements Project {
	...
	public void setProjectName(String newProjectName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.PROJECT__PROJECT_NAME, oldProjectName,
					projectName));
	}
	...
	public EList<SWVS.System> getSystem() {
		if (system == null) {
			system = new EObjectContainmentEList<SWVS.System>(SWVS.System.class, this, SWVSPackage.PROJECT__SYSTEM);
		}
		return system;
	}
	...
	public EList<SWVS.Class> getClass_() {
		if (class_ == null) {
			class_ = new EObjectContainmentEList<SWVS.Class>(SWVS.Class.class, this, SWVSPackage.PROJECT__CLASS);
		}
		return class_;
	}
	...
	public EList<SWVS.Object> getObject() {
		if (object == null) {
			object = new EObjectContainmentEList<SWVS.Object>(SWVS.Object.class, this, SWVSPackage.PROJECT__OBJECT);
		}
		return object;
	}
	...
	public EList<SWVS.Object> getObjList() {
		if (objList == null) {
			objList = new EObjectResolvingEList<SWVS.Object>(SWVS.Object.class, this, SWVSPackage.PROJECT__OBJ_LIST);
		}
		return objList;
	}
	...
	public void setFinDate(String newFinDate) {
		...
		finDate = newFinDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.PROJECT__FIN_DATE, oldFinDate, finDate));
	}
