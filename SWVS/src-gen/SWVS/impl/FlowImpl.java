 ...
 *   <li>{@link SWVS.impl.FlowImpl#getRequirement <em>Requirement</em>}</li>
...
public class FlowImpl extends ObjectImpl implements Flow {
	...
	public void setFlowId(String newFlowId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.FLOW__FLOW_ID, oldFlowId, flowId));
	}
	...
	public EList<SWVS.Object> getHost() {
		if (host == null) {
			host = new EObjectResolvingEList<SWVS.Object>(SWVS.Object.class, this, SWVSPackage.FLOW__HOST);
		}
		return host;
	}
	...
	public EList<SWVS.Object> getClient() {
		if (client == null) {
			client = new EObjectResolvingEList<SWVS.Object>(SWVS.Object.class, this, SWVSPackage.FLOW__CLIENT);
		}
		return client;
	}
	...
	public void setContext(String newContext) {
		...
		context = newContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.FLOW__CONTEXT, oldContext, context));
	}
	...
	public EList<Flow> getDetailFlow() {
		if (detailFlow == null) {
			detailFlow = new EObjectContainmentEList<Flow>(Flow.class, this, SWVSPackage.FLOW__DETAIL_FLOW);
		}
		return detailFlow;
	}
	...
	public void setResult(String newResult) {
		...
		result = newResult;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SWVSPackage.FLOW__RESULT, oldResult, result));
	}
	...
	public EList<Condition> getCondition() {
		if (condition == null) {
			condition = new EObjectContainmentEList<Condition>(Condition.class, this, SWVSPackage.FLOW__CONDITION);
		}
		return condition;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case SWVSPackage.FLOW__CLIENT:
			return getClient();
		case SWVSPackage.FLOW__REQUIREMENT:
